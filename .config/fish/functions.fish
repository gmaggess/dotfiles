...
function emptytrash -d 'Empty the Trash on all mounted volumes and the main HDD. then clear the useless sleepimage'
    ...
    grm -rf ~/.Trash/*
    # rm -rfv /Users/gmaggessy sudo ~/Library/Google/GoogleSoftwareUpdate/GoogleSoftwareUpdate.bundle/Contents/Resour‌​ces/GoogleSoftwareUpdateAgent.app/Contents/Resources/ksinstall --uninstall/Library/Application\ Support/stremio/Cache
    # rm -rfv /Users/gmaggessy sudo ~/Library/Google/GoogleSoftwareUpdate/GoogleSoftwareUpdate.bundle/Contents/Resour‌​ces/GoogleSoftwareUpdateAgent.app/Contents/Resources/ksinstall --uninstall/Library/Application\ Support/stremio/stremio-cache
